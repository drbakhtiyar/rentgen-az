...
- [ ] **51 dental PENDING-i nəzərdən keçir** — `/admin/merkezler?status=PENDING&has=dental`.
  A qrupu (18-i) sitat-təsdiqli 3D/panoram xidmətlərlə gəlir; B qrupu (33) yalnız
  dental-rentgen — zəngdə 3D/panoram dəqiqləşdir. (İmaməliyeva, Qalaaltı Hotel,
  ATU istifadəçi qərarı ilə silindi.) Mənbə: ~/rentgen_az_hedef_klinikalar.xlsx
...
- [x] **6 yeni bloq yazısının RU versiyaları — DONE 2026-08-10.** Sluglar:
  chto-takoe-mrt, kt-ili-mrt-raznica, rentgen-pri-beremennosti,
  podgotovka-k-uzi-bryushnoy-polosti, mammografiya-s-kakogo-vozrasta,
  chto-takoe-densitometriya-dexa. Cover-lər AZ ilə ortaq, daxili linklər /ru/ prefiksli.
  RU bloq cəmi 18 yazı.
