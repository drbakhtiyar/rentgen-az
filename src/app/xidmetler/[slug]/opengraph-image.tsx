...
export const alt = "Rentgen xidməti — rentgen.az";
...
export default async function Image({
  ...
  const name = service?.name ?? "Rentgen xidməti";
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          <div style={{ fontSize: 72, fontWeight: 800, lineHeight: 1.05, maxWidth: 1040 }}>
            {name}
          </div>
          <div style={{ fontSize: 32, color: "#9fb4d6", maxWidth: 960 }}>
            Bakı və regionlarda təsdiqlənmiş mərkəzlər, qiymət və ünvanlar
          </div>
        </div>

        <div style={{ display: "flex", gap: 12 }}>
          {["Qiymət müqayisəsi", "Təsdiqlənmiş mərkəzlər", "Onlayn qeydiyyat"].map((t) => (
            <div
              key={t}
              style={{
                fontSize: 24,
