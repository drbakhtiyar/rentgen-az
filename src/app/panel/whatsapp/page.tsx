  ...
  return (
    ...
    >
      ...
      <div className="mb-4 flex flex-wrap gap-2">
        {(
          [
            ["price", "💰 Qiymət", "/panel/whatsapp"],
            ["faq", "❓ FAQ", "/panel/whatsapp?tab=faq"],
            ["card", "📋 Kart (xidmət təsdiqi)", "/panel/whatsapp?tab=card"],
            ["cabinet", "🔑 Kabinet", "/panel/whatsapp?tab=cabinet"],
          ] as const
        ).map(([k, label, href]) => (
          <Link
            key={k}
