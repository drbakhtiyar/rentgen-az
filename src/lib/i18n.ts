...
type Dict = {
  ...
  referral: {
    ...
    serviceTypeHint: string; serviceNoMatch: string;
...
const az: Dict = {
  ...
  footer: {
    tagline:
      "Azərbaycanda rentgen, KT, MRT, USM, mammoqrafiya və dental tomoqrafiya (CBCT) mərkəzləri — bir platformada.",
    platform: "Platforma",
    company: "Şirkət",
    about: "Haqqımızda",
    faq: "FAQ",
  ...
  referral: {
    ...
    serviceTypeHint: "Yazmağa başlayın — ən azı 3 hərf",
    serviceNoMatch: "Bu mərkəzdə uyğun xidmət tapılmadı",
...
const ru: Dict = {
  ...
  footer: {
    tagline:
      "Центры рентгена, КТ, МРТ, УЗИ, маммографии и дентальной томографии (КЛКТ) в Азербайджане — на одной платформе.",
    platform: "Платформа",
    company: "Компания",
    about: "О нас",
    faq: "Вопросы",
  ...
  referral: {
    ...
    serviceTypeHint: "Начните вводить — минимум 3 буквы",
    serviceNoMatch: "В этом центре нет подходящей услуги",
