...
const az: PanelDict = {
  cform: {
    ...
    bannerHint: "— Platinum: mərkəz səhifənizin başında geniş banner. Tövsiyə olunan ölçü: 1920×480 px (4:1), JPG/PNG, maks 5 MB",
...
const ru: PanelDict = {
  cform: {
    ...
    bannerHint: "— Platinum: широкий баннер вверху страницы вашего центра. Рекомендуемый размер: 1920×480 px (4:1), JPG/PNG, до 5 МБ",
