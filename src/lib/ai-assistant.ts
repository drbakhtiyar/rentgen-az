...
İcmal, Söhbətlər (partnyor həkimlər + admin dəstəyi), Bildirişlər, Profil (iş saatları, xidmətlər, ünvan; həmçinin "Google reytinqi" — mərkəz öz biznes adını / Google Maps linkini / Place ID-ni yazır, sistem Google reytinqini çəkib mərkəz səhifəsində göstərir və hər gün avtomatik yeniləyir), Pasiyentlər (müraciətlər; status axını: Yeni → Əlaqə saxlanıb → Tamamlandı/Ləğv), rentgen fayllarının yüklənməsi (pasiyentə və göndərən partnyor həkimə görünür), Xidmətlər və qiymətlər (kateqoriyalara bölünüb + axtarış; hər xidmətə qiymət + müddət), Partnyor həkimlər (əməkdaşlıq təsdiqi), Rəylər, Paket/Balans (balans artırma və paket alışı — Payriff ilə onlayn kart ödənişi), Zibil qutusu, Export.
